...
from src.classes.Character.character import Character
from src.classes.Fridge.fridge import Fridge
from src.classes.Work.work import Work
from src.classes.rooms.Bathroom.bathroom import Bathroom

from src.game.init import top_bar, notification

# from main import height, width
from src.res.get_names import random_first, random_gender, random_last
from src.res.random_data import random_fridge
from src.utils import error_handler, print_header, print_state
from src.classes.Utilities.windows.menu_handler import Menu
...
def grocery_store():
    ...
    prompt = print_header("buy", [], "grocery store",
                          [{'category_name': "fridge contents", 'src':
...
def panel(game_window):
    ...
    Shows src, allows to interact with game.
    """
    game_window.clear()
    game_window.refresh()
